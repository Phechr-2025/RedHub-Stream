...
โปรเจกต์นี้เป็นเว็บดูวิดีโอแบบ Flask พร้อมตัวจัดการติดตั้ง/อัปเดต/เว็บ/`.env` ชื่อ `menuwed`
...
- เพิ่มเมนูจัดการเว็บ, อัปเดตระบบ, อัปเดตแบบเจาะจง, อัปเดตไลบรารี, และจัดการ `.env`
...
- `menuwed.py` — ตัวเมนูหลัก, install/update/web/.env
...
ถ้าต้องการบังคับใช้ ให้ตั้ง `TURNSTILE_REQUIRED=true` และใส่คีย์ให้ครบใน `.env`
