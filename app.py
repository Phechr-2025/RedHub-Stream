            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:440px;background-color:#1a1d24;border-radius:16px;overflow:hidden;border:1px solid #2a2e38;">
              ...
              <tr>
                <td style="padding:0 32px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#0f1115;border:1px solid #6c5ce7;border-radius:12px;">
                    <tr>
                      <td align="center" style="padding:22px 16px;">
                        <span style="font-size:34px;font-weight:700;letter-spacing:10px;color:#ffffff;font-family:'Courier New',monospace;">{code_spaced}</span>
                      </td>
                    </tr>
                  </table>
                </td>
...
def recover_otp():
    ...
    return render_template(
        ...
        flow="recover",
        resend_available=True,
        cooldown_seconds=get_otp_cooldown_seconds(),
    )
